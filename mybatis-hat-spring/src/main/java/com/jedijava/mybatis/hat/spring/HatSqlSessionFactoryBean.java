 ...
 */
package com.jedijava.mybatis.hat.spring;
...
import com.jedijava.mybatis.hat.exception.ConnectException;
import com.jedijava.mybatis.hat.meta.TableMetaFactory;
import com.jedijava.mybatis.hat.override.HatConfig;
import com.jedijava.mybatis.hat.utils.HatBeanUtil;
 ...
 * @see #setDataSource
 */
public class HatSqlSessionFactoryBean
        implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HatSqlSessionFactoryBean.class);
    ...
    //变更
    private String environment = HatSqlSessionFactoryBean.class.getSimpleName();
     ...
     * @since 1.3.0
     */
    public void setConfiguration(HatConfig configuration) {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        try {
            ...
            TableMetaFactory.initTableSchema(sqlSession);
        } catch (Exception e) {
            LOGGER.error(() -> "加载表结构信息异常");
            throw new ConnectException(e);
        }

        //xml扫描配置(调整了此方法调用的时机,原来此代码在buildSqlSessionFactory方法内)
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        //config 变更
        final HatConfig targetConfiguration;
        ...
        if (this.configuration != null) {
            ...
            targetConfiguration = HatBeanUtil.copyProperties(configuration, HatConfig.class);
        } else {
            LOGGER.debug(
                    () -> "Property 'configuration' or 'configLocation' not specified, using default MyBatis Configuration");
            //new HatConfig
            targetConfiguration = new HatConfig();
