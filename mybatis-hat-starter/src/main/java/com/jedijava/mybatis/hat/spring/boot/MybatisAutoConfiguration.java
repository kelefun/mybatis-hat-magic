...
@ConditionalOnClass({ SqlSessionFactory.class, HatSqlSessionFactoryBean.class })
...
public class MybatisAutoConfiguration implements InitializingBean {
  ...
  public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
    HatSqlSessionFactoryBean factory = new HatSqlSessionFactoryBean();
  ...
  private void applySqlSessionFactoryBeanCustomizers(HatSqlSessionFactoryBean factory) {
